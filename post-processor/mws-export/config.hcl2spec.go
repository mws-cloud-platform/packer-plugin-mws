...
type FlatConfig struct {
	...
	AdditionalDiskForExportSize     *string           `mapstructure:"additional_disk_for_export_size" required:"false" cty:"additional_disk_for_export_size" hcl:"additional_disk_for_export_size"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"additional_disk_for_export_size":     &hcldec.AttrSpec{Name: "additional_disk_for_export_size", Type: cty.String, Required: false},
