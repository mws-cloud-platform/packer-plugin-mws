...
You can find pre-built binary releases of the plugin [here](https://github.com/mws-cloud-platform/packer-plugin-mws/releases).
...
locally and run the command `go build` from the root directory. Upon successful
compilation, a `packer-plugin-mws` plugin binary file can be found in the root
directory. To install the compiled plugin, please follow the official Packer
